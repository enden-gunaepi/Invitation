...
<html lang="id" data-layout-ready="false"
    ...
    x-init="
        ...
        $watch('sidebarExpanded', val => { localStorage.setItem('adminSidebarExpanded', val); syncLayoutVars(); });
...
<body class="text-[--on-surface] font-sans antialiased overflow-hidden transition-colors duration-300"
    ...
    <!-- Toasts -->
    @if (session('success'))
        <div class="fixed top-6 right-6 z-[9999] bg-[--surface-lowest] border border-green-500/20 text-green-700 dark:text-green-400 px-5 py-3 rounded-xl shadow-[0_10px_40px_rgba(0,0,0,0.08)] flex items-center gap-3 animate-slide-up" style="border-color: var(--outline-variant);">
            <span class="material-symbols-outlined text-green-600" style="font-size:18px;">check_circle</span>
            <span class="text-sm font-medium">{{ session('success') }}</span>
        </div>
    @endif
    @if (session('error'))
        <div class="fixed top-6 right-6 z-[9999] bg-[--surface-lowest] border text-red-700 dark:text-red-400 px-5 py-3 rounded-xl shadow-[0_10px_40px_rgba(0,0,0,0.08)] flex items-center gap-3 animate-slide-up" style="border-color: rgba(186,26,26,0.3);">
        ...
        <nav class="flex-1 overflow-y-auto scrollbar-hide px-3 py-4 flex flex-col gap-5">
            ...
            <div class="flex flex-col gap-0.5">
                ...
                <a href="{{ route('admin.users.index') }}"
                    ...
                    <span class="text-sm whitespace-nowrap overflow-hidden"
                          style="transition: opacity 0.2s ease, max-width 0.3s cubic-bezier(0.4,0,0.2,1);"
                          :style="{ opacity: (!isMobile && !sidebarExpanded) ? '0' : '1', maxWidth: (!isMobile && !sidebarExpanded) ? '0' : '200px' }">Users</span>
                </a>
                ...
                <a href="{{ route('admin.invitations.index') }}"
                    ...
                    <span class="text-sm whitespace-nowrap overflow-hidden flex-1"
                          style="transition: opacity 0.2s ease, max-width 0.3s cubic-bezier(0.4,0,0.2,1);"
                          :style="{ opacity: (!isMobile && !sidebarExpanded) ? '0' : '1', maxWidth: (!isMobile && !sidebarExpanded) ? '0' : '200px' }">Undangan</span>
                ...
                <a href="{{ route('admin.templates.index') }}"
                    ...
                    <span class="text-sm whitespace-nowrap overflow-hidden"
                          style="transition: opacity 0.2s ease, max-width 0.3s cubic-bezier(0.4,0,0.2,1);"
                          :style="{ opacity: (!isMobile && !sidebarExpanded) ? '0' : '1', maxWidth: (!isMobile && !sidebarExpanded) ? '0' : '200px' }">Template</span>
                </a>
                ...
                <a href="{{ route('admin.packages.index') }}"
                    ...
                    <span class="text-sm whitespace-nowrap overflow-hidden"
                          style="transition: opacity 0.2s ease, max-width 0.3s cubic-bezier(0.4,0,0.2,1);"
                          :style="{ opacity: (!isMobile && !sidebarExpanded) ? '0' : '1', maxWidth: (!isMobile && !sidebarExpanded) ? '0' : '200px' }">Paket</span>
                </a>
                ...
                <a href="{{ route('admin.payments.index') }}"
                    ...
                    <span class="text-sm whitespace-nowrap overflow-hidden flex-1"
                          style="transition: opacity 0.2s ease, max-width 0.3s cubic-bezier(0.4,0,0.2,1);"
                          :style="{ opacity: (!isMobile && !sidebarExpanded) ? '0' : '1', maxWidth: (!isMobile && !sidebarExpanded) ? '0' : '200px' }">Pembayaran</span>
                ...
                <a href="{{ route('admin.affiliate.payouts') }}"
                    ...
                    <span class="text-sm whitespace-nowrap overflow-hidden flex-1"
                          style="transition: opacity 0.2s ease, max-width 0.3s cubic-bezier(0.4,0,0.2,1);"
                          :style="{ opacity: (!isMobile && !sidebarExpanded) ? '0' : '1', maxWidth: (!isMobile && !sidebarExpanded) ? '0' : '200px' }">Affiliate Payout</span>
            ...
            <div class="flex flex-col gap-0.5">
                ...
                <a href="{{ route('admin.system.reliability') }}"
                    ...
                    <span class="text-sm whitespace-nowrap overflow-hidden flex-1"
                          style="transition: opacity 0.2s ease, max-width 0.3s cubic-bezier(0.4,0,0.2,1);"
                          :style="{ opacity: (!isMobile && !sidebarExpanded) ? '0' : '1', maxWidth: (!isMobile && !sidebarExpanded) ? '0' : '200px' }">Reliability</span>
                ...
                <a href="{{ route('admin.system.media-maintenance') }}"
                    ...
                    <span class="text-sm whitespace-nowrap overflow-hidden flex-1"
                          style="transition: opacity 0.2s ease, max-width 0.3s cubic-bezier(0.4,0,0.2,1);"
                          :style="{ opacity: (!isMobile && !sidebarExpanded) ? '0' : '1', maxWidth: (!isMobile && !sidebarExpanded) ? '0' : '200px' }">Media Maintenance</span>
                </a>
            </div>
        </nav>
                    ...
                    <div x-show="userMenuOpen" @click.outside="userMenuOpen = false"
                        ...
                        <a href="{{ route('admin.settings.index') }}"
                           ...
                           onmouseout="this.style.background=''; this.style.color='var(--on-surface-variant)'">
                            <span class="material-symbols-outlined" style="font-size: 17px;">settings</span> Pengaturan
                        </a>
        ...
        <div x-show="companyModalOpen"
            ...
            <div style="padding: 24px 32px 32px 32px; position: relative; z-index: 20; background: var(--surface-lowest);">
                ...
                <div style="font-size: 14px; color: var(--text-secondary); line-height: 1.6; margin-bottom: 24px;">
                    <p style="margin-top: 0; margin-bottom: 8px;"><strong style="color: var(--text); font-weight: 600;">Email:</strong> {{ $brandEmail ?? auth()->user()->email }}</p>
                    @if($brandPhone)
                        <p style="margin-top: 0; margin-bottom: 8px;"><strong style="color: var(--text); font-weight: 600;">Phone:</strong> {{ $brandPhone }}</p>
                    @endif
                    @if($brandAddress)
                        <p style="margin-top: 0; margin-bottom: 0;"><strong style="color: var(--text); font-weight: 600;">Address:</strong> {{ $brandAddress }}</p>
                    @endif
                </div>
