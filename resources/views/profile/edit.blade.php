...
<div class="profile-shell space-y-6" x-data="{ tab: 'profile' }">
    ...
    <div class="flex flex-col lg:flex-row gap-6 items-start">
        ...
        <div class="hidden lg:flex flex-col items-center justify-center p-8 bg-white border border-gray-200/50 rounded-2xl w-80 shrink-0 shadow-sm" style="background: linear-gradient(180deg, rgba(255,255,255,.88), rgba(248,250,252,.78)); backdrop-filter: blur(8px);">
            ...
            <p class="text-xs text-center text-on-surface-variant/80 px-4 leading-relaxed">Kelola preferensi akun Anda, detail personal, profil bisnis, dan kredensial keamanan secara terpusat.</p>
        </div>
    </div>
</div>
@endsection
