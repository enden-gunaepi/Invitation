...
<style>
    ...
    .mac-dot { width: 11px; height: 11px; border-radius: 50%; box-shadow: inset 0 0 0 1px rgba(0,0,0,.15); }
    .mac-dot.red { background: #ff5f57; }
    .mac-dot.yellow { background: #febc2e; }
    .mac-dot.green { background: #28c840; }
    .mac-title { font-size: .78rem; font-weight: 600; color: var(--text-secondary); letter-spacing: .02em; }
    .mac-body { padding: 1.2rem; display: grid; grid-template-columns: 1fr; gap: 1rem; }
    .profile-block {
        border: 1px solid rgba(148, 163, 184, .22);
    ...
    .profile-title { font-weight: 700; color: var(--accent); margin-bottom: .15rem; }
    .profile-sub { font-size: .8rem; color: var(--text-secondary); margin-bottom: .8rem; }
...
<div class="profile-shell space-y-6">
    <div class="flex flex-col lg:flex-row gap-6 items-start">
        <div class="mac-panel flex-1 w-full max-w-2xl">
            <div class="mac-head">
                <div class="mac-dots">
                ...
                <div class="mac-title">192.168.1.1 — Profile Settings</div>
                <div style="width:52px;"></div>
            </div>

            <div class="mac-body !grid-cols-1">
        ...
        <div class="hidden lg:flex flex-col items-center justify-center p-8 bg-white border border-gray-200/50 rounded-2xl w-80 shrink-0 shadow-sm" style="background: linear-gradient(180deg, rgba(255,255,255,.88), rgba(248,250,252,.78)); backdrop-filter: blur(8px);">
