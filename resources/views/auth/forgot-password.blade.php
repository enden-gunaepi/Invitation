    ...
    <div class="split-layout">
        ...
        <div class="visual-side">
            ...
            <div class="visual-content" style="display: flex; flex-direction: column; align-items: center; justify-content: center;">
                <img src="{{ asset('assets/maskot/kirimemail.png') }}" alt="Forgot Password Mascot" style="height: 180px; width: auto; object-contain; margin-bottom: 2rem; filter: drop-shadow(0 10px 15px rgba(0,0,0,0.08));">
                <h2>The Standard</h2>
                <p>Ensuring operational continuity with advanced access recovery protocols. Restore your pipeline with ease.</p>
            </div>
        </div>
        ...
        <div class="form-side">
            <div class="auth-container">
                ...
                <div class="auth-header">
                    ...
                    <p class="auth-subtitle">No problem. Enter your email address and we'll send you a password reset link.</p>
                </div>
                ...
                <form method="POST" action="{{ route('password.email') }}">
                    ...
                    <button type="submit" class="btn-auth">Email Password Reset Link</button>
                </form>
