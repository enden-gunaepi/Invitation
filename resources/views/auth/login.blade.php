    ...
    <div class="split-layout">
        ...
        <div class="visual-side">
            ...
            <div class="visual-content" style="display: flex; flex-direction: column; align-items: center; justify-content: center;">
                <img src="{{ asset('assets/maskot/Login.png') }}" alt="Login Mascot" style="height: 180px; width: auto; object-contain; margin-bottom: 2rem; filter: drop-shadow(0 10px 15px rgba(0,0,0,0.08));">
                <h2>The Standard</h2>
