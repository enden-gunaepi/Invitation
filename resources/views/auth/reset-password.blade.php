        ...
        <div class="form-side">
            <div class="auth-container">
                ...
                <div class="auth-header">
                    ...
                    <p class="auth-subtitle">Set a secure new password for your account.</p>
                </div>
                ...
                <form method="POST" action="{{ route('password.store') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input id="email" type="email" name="email" value="{{ old('email', $request->email) }}" class="form-input" placeholder="name@company.com" required autofocus autocomplete="username">
