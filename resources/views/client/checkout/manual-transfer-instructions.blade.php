...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="text-center space-y-2 mb-8">
        ...
        <h2 class="text-xl font-bold">Menunggu Pembayaran</h2>
    ...
    <div class="card p-6" id="upload-section">
        ...
        <form method="POST" action="{{ route('client.checkout.manual-transfer.proof', $invitation) }}" enctype="multipart/form-data" class="space-y-4">
            @csrf
