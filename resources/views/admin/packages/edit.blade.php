        ...
        <form method="POST" action="{{ route('admin.packages.update', $package) }}">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-5 mb-5">
                ...
                <div>
                    ...
                    <input type="number" name="max_guests" value="{{ old('max_guests', $package->max_guests) }}" class="form-input" min="1" required>
                </div>
                <div>
                    <label class="form-label">Max Foto</label>
                    <input type="number" name="max_photos" value="{{ old('max_photos', $package->max_photos) }}" class="form-input" min="1" required>
                </div>
                <div>
            ...
            <div class="mb-5">
                ...
                <textarea name="addons_input" class="form-input" rows="3">{{ old('addons_input', implode("\n", $package->addons ?? [])) }}</textarea>
            </div>
            <div class="mb-5">
            ...
            <div class="mb-6">
                <label class="flex items-center gap-2 cursor-pointer">
                    <input type="checkbox" name="is_active" value="1" {{ $package->is_active ? 'checked' : '' }} class="w-4 h-4 rounded bg-slate-800 border-slate-600 text-indigo-500">
