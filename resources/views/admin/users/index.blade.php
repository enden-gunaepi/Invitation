...
@section('content')
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
        <form class="flex items-center gap-3" method="GET">
            ...
            <div class="relative">
                ...
                <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari user..."
                    class="form-input pl-9 pr-3 w-64">
        ...
        <a href="{{ route('admin.users.create') }}" class="btn-primary text-sm rounded-md px-2 py-1">
    ...
    <div class="card overflow-hidden">
        <table class="data-table">
            ...
            <tbody>
                    ...
                    <tr>
                        <td>
                            <div class="flex items-center gap-3">
                                <div
                                    class="w-9 h-9 rounded-full bg-gradient-to-br from-indigo-500 to-purple-500 flex items-center justify-center text-white text-sm font-bold">
                        ...
                        <td>
                            ...
                            @else
                                <span class="badge badge-rejected"><i class="fas fa-circle text-[8px] mr-1"></i>
                                    Nonaktif</span>
                            @endif
                        </td>
                        ...
                        <td class="text-right">
                            <a href="{{ route('admin.users.edit', $user) }}"
                                class="text-indigo-400 hover:text-indigo-300 text-sm mr-3">
                            ...
                            @if ($user->id !== auth()->id())
                                <form method="POST" action="{{ route('admin.users.destroy', $user) }}" class="inline"
                                    ...
                                    @csrf @method('DELETE')
                                    <button class="text-red-400 hover:text-red-300 text-sm"><i
                ...
                @empty
                    <tr>
                        <td colspan="6" class="text-center py-8 text-slate-500">Tidak ada data user</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
